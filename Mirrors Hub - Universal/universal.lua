...
btnTitle(Tabs.Scripts,"FE R6 Animations",function()runExternal("https://raw.githubusercontent.com/Fsploit/FeAnimationHub/refs/heads/main/Hub.lua")end)
btnTitle(Tabs.Scripts,"JERK OFF R6",function()runExternal("https://pastefy.app/wa3v2Vgm/raw")end)
btnTitle(Tabs.Scripts,"R15",function()runExternal("https://pastefy.app/YZoglOyJ/raw")end)
