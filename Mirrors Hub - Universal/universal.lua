--// ==========================================================
--// MIRRORS HUB - UNIVERSAL REORGANIZED
--// Robox 2 Authorized Environment
--// Folder: MirrorsHub
--// Config: universal-config
--// Loader kept unchanged
--// ==========================================================
...
local HUB_VERSION = "1.5 Reorganized"
...
local Languages = {
    English = {
        ...
        SectionGodMode = "God Mode",
        SectionProtection = "Protection",
        SectionFling = "Fling Tools",
        ...
        HitboxSizeDesc = "Size applied to selected hitbox part.",
        HitboxTransparency = "Hitbox Transparency",
        HitboxTransparencyDesc = "Transparency of expanded hitbox.",
        HitboxColor = "Hitbox Color",
        HitboxColorDesc = "Color of expanded hitbox.",
        ...
        HitboxTargetPartDesc = "Body part used as expanded hitbox.",
        ResetHitboxes = "Reset Hitboxes",
        ResetHitboxesDesc = "Restore modified hitboxes.",
        HitboxesReset = "Hitboxes reset.",

        GodMode100 = "God Mode 1",
        GodMode100Desc = "Keeps your health always at 100.",
        GodModeInf = "God Mode 2",
        GodModeInfDesc = "Sets your health to infinite.",
        AntiFling = "Anti Fling",
        AntiFlingDesc = "Disables your character collision and cuts unstable physics.",
        TouchFling = "Touch Fling C-137",
        TouchFlingDesc = "Touch players to launch them to dimension C-137 while you stay stable.",
        TouchFlingPower = "Touch Fling Power",
        TouchFlingPowerDesc = "Dimensional launch force.",
        RefreshTouchFling = "Refresh Touch Fling",
        RefreshTouchFlingDesc = "Rebuilds Touch Fling connections on current character.",
        ...
        ResetSessionDesc = "Disable active session features.",
        ...
        NotificationsDesc = "Enable or disable hub notifications.",
        Theme = "Theme",
        ThemeDesc = "Change interface theme.",
        ToggleUIKey = "Toggle UI Key",
        ToggleUIKeyDesc = "Key to open/close the UI.",
        DestroyUI = "Destroy UI",
        DestroyUIDesc = "Completely removes the hub from screen.",
        ...
        AntiFlingOn = "Anti Fling enabled.",
        AntiFlingOff = "Anti Fling disabled.",
        TouchFlingOn = "Touch Fling C-137 enabled.",
        TouchFlingOff = "Touch Fling disabled.",
        TouchFlingRefreshed = "Touch Fling refreshed."
    },
    ...
    Portuguese = {
        ...
        SectionGodMode = "God Mode",
        SectionProtection = "Proteção",
        SectionFling = "Ferramentas de Fling",
        ...
        GodMode100 = "God Mode 1",
        GodMode100Desc = "Mantém sua vida sempre em 100.",
        GodModeInf = "God Mode 2",
        GodModeInfDesc = "Deixa sua vida infinita.",
        AntiFling = "Anti Fling",
        AntiFlingDesc = "Remove colisão do seu personagem e corta física bugada.",
        TouchFling = "Touch Fling C-137",
        TouchFlingDesc = "Ao encostar em players, lança eles pra dimensão C-137 enquanto você fica estável.",
        TouchFlingPower = "Força do Touch Fling",
        TouchFlingPowerDesc = "Força do lançamento dimensional.",
        RefreshTouchFling = "Atualizar Touch Fling",
        RefreshTouchFlingDesc = "Recria conexões do Touch Fling no personagem atual.",
        ...
        ResetSessionDesc = "Desliga funções ativas da sessão.",
        ...
        NotificationsDesc = "Liga ou desliga notificações do hub.",
        Theme = "Tema",
        ThemeDesc = "Muda o tema da interface.",
        ToggleUIKey = "Tecla da UI",
        ToggleUIKeyDesc = "Tecla para abrir/fechar a interface.",
        DestroyUI = "Destruir UI",
        DestroyUIDesc = "Remove completamente o hub da tela.",
        ...
        AntiFlingOn = "Anti Fling ativado.",
        AntiFlingOff = "Anti Fling desativado.",
        TouchFlingOn = "Touch Fling C-137 ativado.",
        TouchFlingOff = "Touch Fling desativado.",
        TouchFlingRefreshed = "Touch Fling atualizado."
    },
    ...
    Spanish = {
        ...
        SectionGodMode = "God Mode",
        SectionProtection = "Protección",
        SectionFling = "Herramientas de Fling",
        ...
        GodMode100 = "God Mode 1",
        GodMode100Desc = "Mantiene tu vida siempre en 100.",
        GodModeInf = "God Mode 2",
        GodModeInfDesc = "Deja tu vida infinita.",
        AntiFling = "Anti Fling",
        AntiFlingDesc = "Desactiva colisión de tu personaje y corta física inestable.",
        TouchFling = "Touch Fling C-137",
        TouchFlingDesc = "Al tocar jugadores, los lanza a la dimensión C-137 mientras tú quedas estable.",
        TouchFlingPower = "Fuerza del Touch Fling",
        TouchFlingPowerDesc = "Fuerza del lanzamiento dimensional.",
        RefreshTouchFling = "Actualizar Touch Fling",
        RefreshTouchFlingDesc = "Reconstruye conexiones del Touch Fling en el personaje actual.",
        ...
        ResetSessionDesc = "Desactiva funciones activas de la sesión.",
        ...
        NotificationsDesc = "Activa o desactiva notificaciones del hub.",
        Theme = "Tema",
        ThemeDesc = "Cambia el tema de la interfaz.",
        ToggleUIKey = "Tecla de UI",
        ToggleUIKeyDesc = "Tecla para abrir/cerrar la interfaz.",
        DestroyUI = "Destruir UI",
        DestroyUIDesc = "Elimina completamente el hub de la pantalla.",
        ...
        AntiFlingOn = "Anti Fling activado.",
        AntiFlingOff = "Anti Fling desactivado.",
        TouchFlingOn = "Touch Fling C-137 activado.",
        TouchFlingOff = "Touch Fling desactivado.",
        TouchFlingRefreshed = "Touch Fling actualizado."
    }
}
...
WindUI:AddTheme({
    ...
    Outline = Color3.fromHex("#374151"),
    Text = Color3.fromHex("#FFFFFF"),
    Placeholder = Color3.fromHex("#9CA3AF"),
    Button = Color3.fromHex("#1F2937"),
...
local OP = Window:Tab({ Title = L("TabOP"), Icon = "flame", Locked = false })
...
local function ForceSafeStartupState()
    AimConfig.Enabled = false
    AimConfig.FOVVisible = false
...
local function ApplyGodMode()
    ...
    if OPConfig.GodModeInf then
        hum.MaxHealth = math.huge
        hum.Health = math.huge
        return
    end

    if OPConfig.GodMode100 then
        hum.MaxHealth = 100
        hum.Health = 100
    end
end
...
local function ApplyAntiFling()
    if not OPConfig.AntiFling and not OPConfig.TouchFling then return end
...
local function FlingTarget(player)
    if not OPConfig.TouchFling then return end
    ...
    if not localRoot or not root or not hum or hum.Health <= 0 then return end

    local savedCFrame = localRoot.CFrame
    local savedVelocity = localRoot.AssemblyLinearVelocity
    local savedAngular = localRoot.AssemblyAngularVelocity
    ...
    local power = OPConfig.TouchFlingPower

    root.AssemblyLinearVelocity = direction * power
    ...
    task.defer(function()
        if localRoot and localRoot.Parent then
            ...
            localRoot.AssemblyLinearVelocity = savedVelocity * 0
            localRoot.AssemblyAngularVelocity = savedAngular * 0
        end
    end)
end

local function ClearTouchFlingConnections()
    for _, connection in ipairs(TouchFlingConnections) do
        if connection then
...
local function SetupTouchFling()
    ...
    for _, part in ipairs(char:GetDescendants()) do
        if part:IsA("BasePart") then
            ...
            table.insert(TouchFlingConnections, connection)
        end
    end
end
...
Misc:Slider({
    ...
    Flag = "HitboxSize",
    Step = 1,
    Value = { Min = 2, Max = 50, Default = HitboxConfig.Size },
    Callback = function(v)
        HitboxConfig.Size = v
        UpdateHitboxes()
    end
...
Misc:Slider({
    ...
    Step = 1,
    Value = { Min = 0, Max = 100, Default = math.floor(HitboxConfig.Transparency * 100) },
    Callback = function(v)
...
OP:Section({ Title = L("SectionGodMode"), Box = false, TextSize = 17 })

OP:Toggle({
    Title = L("GodMode100"),
    Desc = L("GodMode100Desc"),
    Flag = "OPGodMode100",
    Type = "Checkbox",
    Value = false,
    Callback = function(v)
        OPConfig.GodMode100 = v

        if v then
            OPConfig.GodModeInf = false
        end
    end
})
...
OP:Toggle({
    Title = L("GodModeInf"),
    Desc = L("GodModeInfDesc"),
    Flag = "OPGodModeInf",
    Type = "Checkbox",
    Value = false,
    Callback = function(v)
        OPConfig.GodModeInf = v

        if v then
            OPConfig.GodMode100 = false
        end
    end
})

OP:Section({ Title = L("SectionProtection"), Box = false, TextSize = 17 })

OP:Toggle({
    Title = L("AntiFling"),
    Desc = L("AntiFlingDesc"),
    Flag = "OPAntiFling",
    Type = "Checkbox",
    Value = false,
    Callback = function(v)
        OPConfig.AntiFling = v

        if v then
            Notify(L("AntiFlingOn"), "shield", 3)
        else
            Notify(L("AntiFlingOff"), "shield-off", 3)
        end
    end
})

OP:Section({ Title = L("SectionFling"), Box = false, TextSize = 17 })

OP:Toggle({
    Title = L("TouchFling"),
    Desc = L("TouchFlingDesc"),
    Flag = "OPTouchFling",
    Type = "Checkbox",
    Value = false,
    Callback = function(v)
        OPConfig.TouchFling = v

        if v then
            SetupTouchFling()
            Notify(L("TouchFlingOn"), "zap", 3)
        else
            ClearTouchFlingConnections()
            Notify(L("TouchFlingOff"), "zap-off", 3)
        end
    end
})

OP:Slider({
    Title = L("TouchFlingPower"),
    Desc = L("TouchFlingPowerDesc"),
    Flag = "OPTouchFlingPower",
    Step = 100,
    Value = { Min = 1000, Max = 50000, Default = OPConfig.TouchFlingPower },
    Callback = function(v)
        OPConfig.TouchFlingPower = v
    end
})

OP:Button({
    Title = L("RefreshTouchFling"),
    Desc = L("RefreshTouchFlingDesc"),
    Locked = false,
    Callback = function()
        SetupTouchFling()
        Notify(L("TouchFlingRefreshed"), "refresh-cw", 3)
    end
})
...
Config:Button({
    ...
    Callback = function()
        ...
        OPConfig.GodMode100 = false
        OPConfig.GodModeInf = false
        OPConfig.AntiFling = false
        OPConfig.TouchFling = false
        CurrentTarget = nil
        ClearESP()
        ResetAllHitboxes()
        ClearTouchFlingConnections()
...
Config:Section({ Title = L("SectionServer"), Box = false, TextSize = 17 })
...
Config:Dropdown({
    ...
    Desc = L("ThemeDesc"),
    Flag = "ConfigTheme",
    Values = { "Mirrors Purple", "Midnight", "Dark" },
    Value = "Mirrors Purple",
    Callback = function(v)
        pcall(function()
            WindUI:SetTheme(v)
        end)
...
Config:Section({ Title = L("SectionDanger"), Box = false, TextSize = 17 })

Config:Button({
    Title = L("DestroyUI"),
    Desc = L("DestroyUIDesc"),
    Locked = false,
    Callback = function()
        ClearESP()
        ResetAllHitboxes()
...
--// ==========================================================
--// AUTO LOAD CONFIG WITHOUT STARTUP NOTIFICATION SPAM
--// ==========================================================
