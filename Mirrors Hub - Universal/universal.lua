--// ==========================================================
--// MIRRORS HUB - UNIVERSAL PRO
--// Robox 2 Authorized Environment
--// Folder: MirrorsHub
--// Config: universal-config
--// Loader: kept unchanged by request
--// ==========================================================
...
local HUB_VERSION = "1.4 Pro"
local HUB_FOLDER = "MirrorsHub"
local LANGUAGE_FILE = HUB_FOLDER .. "/language.json"

--// ==========================================================
--// OP WHITELIST
--// Put your Roblox/Robox 2 username or UserId here.
--// UserId is safer, username is easier.
--// ==========================================================
...
local IsOPAuthorized =
    AuthorizedOPUsers[LocalPlayer.UserId] == true
    or AuthorizedOPNames[LocalPlayer.Name] == true

print("[Mirrors Hub] Player:", LocalPlayer.Name, "UserId:", LocalPlayer.UserId, "OP:", IsOPAuthorized)
...
local Languages = {
    English = {
        ...
        OPAccess = "OP Mode",
        OPAccessDesc = "Private functions for authorized users only.",
        OPTest = "Test OP Access",
        OPTestDesc = "Checks if OP tab is unlocked.",
        OPConfirmed = "OP access confirmed.",
        OPPlaceholder = "Placeholder OP Function",
        OPPlaceholderDesc = "Put your private function here later.",
    ...
    Portuguese = {
        ...
        OPAccess = "Modo OP",
        OPAccessDesc = "Funções privadas apenas para usuários autorizados.",
        OPTest = "Testar Acesso OP",
        OPTestDesc = "Verifica se a aba OP está desbloqueada.",
        OPConfirmed = "Acesso OP confirmado.",
        OPPlaceholder = "Função OP Placeholder",
        OPPlaceholderDesc = "Coloque sua função privada aqui depois.",
    ...
    Spanish = {
        ...
        OPAccess = "Modo OP",
        OPAccessDesc = "Funciones privadas solo para usuarios autorizados.",
        OPTest = "Probar Acceso OP",
        OPTestDesc = "Verifica si la pestaña OP está desbloqueada.",
        OPConfirmed = "Acceso OP confirmado.",
        OPPlaceholder = "Función OP Placeholder",
        OPPlaceholderDesc = "Coloca tu función privada aquí después.",
...
local function ApplyAntiFling()
    if not OPConfig.AntiFling then return end
...
OP:Section({ Title = "God Mode", Box = false, TextSize = 17 })

OP:Toggle({
    Title = "God Mode 1",
    Desc = "Mantém sua vida sempre em 100.",
    Flag = "OPGodMode100",
    Type = "Checkbox",
    Value = false,
    Callback = function(v)
...
OP:Section({ Title = "Fling Tools", Box = false, TextSize = 17 })

OP:Toggle({
    Title = "Anti Fling",
    Desc = "Remove colisão do seu personagem e corta física bugada.",
    Flag = "OPAntiFling",
    Type = "Checkbox",
    Value = false,
    Callback = function(v)
        ...
        if v then
            Notify("Anti Fling ativado.", "shield", 3)
        else
            Notify("Anti Fling desativado.", "shield-off", 3)
        end
    end
})

OP:Toggle({
    Title = "Touch Fling C-137",
    Desc = "Ao encostar em players, manda eles pra dimensão C-137.",
    Flag = "OPTouchFling",
    Type = "Checkbox",
    Value = false,
    Callback = function(v)
        ...
        if v then
            SetupTouchFling()
            Notify("Touch Fling C-137 ativado.", "zap", 3)
        else
            ClearTouchFlingConnections()
            Notify("Touch Fling desativado.", "zap-off", 3)
        end
    end
})

OP:Slider({
    Title = "Touch Fling Power",
    Desc = "Força do lançamento dimensional.",
    Flag = "OPTouchFlingPower",
    Step = 100,
    Value = {
        Min = 1000,
        Max = 50000,
        Default = OPConfig.TouchFlingPower
    },
    Callback = function(v)
...
OP:Button({
    Title = "Refresh Touch Fling",
    Desc = "Recria conexões do Touch Fling no personagem atual.",
    Locked = false,
    Callback = function()
        SetupTouchFling()
        Notify("Touch Fling atualizado.", "refresh-cw", 3)
    end
})
