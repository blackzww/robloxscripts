...
section(Tabs.OP,"Utility");local OPPlayerDrop; local function criarDrop() if OPPlayerDrop and OPPlayerDrop.Destroy then pcall(function() OPPlayerDrop:Destroy() end) elseif OPPlayerDrop and OPPlayerDrop.Delete then pcall(function() OPPlayerDrop:Delete() end) end; OPPlayerDrop = drop(Tabs.OP,"SelectPlayer","OPSelectedPlayer",playerNames(),"None",function(v) SelectedPlayer = v end) end; criarDrop(); btn(Tabs.OP,"RefreshPlayers",function() criarDrop(); notify(L("PlayerListUpdated"),"refresh-cw",2) end);btn(Tabs.OP,"TeleportPlayer",tpToPlayer);btn(Tabs.OP,"TeleportBack",teleportBack);btn(Tabs.OP,"BringPlayer",bringPlayer);btn(Tabs.OP,"SpectatePlayer",spectatePlayer);btn(Tabs.OP,"Unspectate",unspectate)
