...
section(Tabs.Troll,"Movement");local TrollPlayerDrop; local function criarDrop() if TrollPlayerDrop then pcall(function() if TrollPlayerDrop.Instance then TrollPlayerDrop.Instance:Destroy() elseif TrollPlayerDrop.Destroy then TrollPlayerDrop:Destroy() end end) end; TrollPlayerDrop = drop(Tabs.Troll,"SelectPlayer","TrollSelectedPlayer",playerNames(),"None",function(v)SelectedPlayer=v end) end; criarDrop(); btn(Tabs.Troll,"RefreshPlayers",function() criarDrop(); notify(L("PlayerListUpdated"),"refresh-cw",2) end);tog(Tabs.Troll,"Orbit","TrollOrbit",false,function(v)TrollC.Orbit=v end);drop(Tabs.Troll,"OrbitMode","TrollOrbitMode",{"Circle","UpDown","LeftRight","Diagonal"},"Circle",function(v)TrollC.OrbitMode=v end);slid(Tabs.Troll,"OrbitRadius","TrollOrbitRadius",2,35,TrollC.OrbitRadius,1,function(v)TrollC.OrbitRadius=v end);slid(Tabs.Troll,"OrbitSpeed","TrollOrbitSpeed",1,40,TrollC.OrbitSpeed,1,function(v)TrollC.OrbitSpeed=v end);slid(Tabs.Troll,"OrbitHeight","TrollOrbitHeight",0,25,TrollC.OrbitHeight,1,function(v)TrollC.OrbitHeight=v end);tog(Tabs.Troll,"SpinBot","TrollSpinBot",false,function(v)TrollC.Spin=v end);slid(Tabs.Troll,"SpinSpeed","TrollSpinSpeed",1,150,TrollC.SpinSpeed,1,function(v)TrollC.SpinSpeed=v end);tog(Tabs.Troll,"HeadSit","TrollHeadSit",false,function(v)TrollC.HeadSit=v;if not v then stopHeadSit()end end)
