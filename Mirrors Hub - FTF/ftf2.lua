--[[
    TungTungTung for Robox 2

    This script is organized by feature. Each section keeps its state, helper
    functions, background work, event connections, and UI controls together so
    individual systems can be located and modified without tracing unrelated code.
]]

-- ============================================================================
-- UI BOOTSTRAP AND THEME
-- Loads WindUI, registers the custom theme, reports anonymous runtime details,
-- creates the main window, and exposes the feature tabs used below.
-- ============================================================================
...
-- ============================================================================
-- HIDER: NEAREST FREEZE POD INTERACTION
-- Locates the nearest enabled pod trigger, moves the character to it, and uses
-- the first interaction method supported by the current compatibility layer.
-- ============================================================================
