...
WINDUI_URL="https://github.com/Footagesus/WindUI/releases/download/1.6.66/main.lua"
okWind,windSource=pcall(function()return game:HttpGet(WINDUI_URL)end)
if not okWind then error("[MIRRORS] Failed to load pinned WindUI 1.6.66: "..tostring(windSource)) end
WindUI=loadstring(windSource)()
