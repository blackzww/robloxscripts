...
local Runtime={Alive=true,Connections={},Cleanups={},Window=nil}
...
-- MISC / CONFIG
--==================================================
Misc:Paragraph({Title="Runtime",Desc="Re-execution safe. Runtime connections, visuals and hooks are cleaned automatically.",Image="activity"})
Misc:Paragraph({Title="Rendering",Desc="ESP uses Drawing 2D when available, with Highlight fallback.",Image="scan"})
Config:Paragraph({Title="Controls",Desc="Open / Close: K\nUI: WindUI\nTheme: Violet",Image="cog"})
Config:Paragraph({Title="Mirrors Engine",Desc="One target resolver.\nOne BulletHandler hook.\nOne ESP render loop.",Image="cpu"})
--==================================================
